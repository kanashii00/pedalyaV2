...
<?php $component->withAttributes(['title' => 'Payment Overview']); ?>
            ...
            <div class="detail-row">
                ...
                <span class="detail-value">
                    ...
                    ?>
                    <span class="payment-method-badge" style="background: <?php echo e($pmBackground); ?>; color: <?php echo e($pmColor); ?>;">
...
<?php $component->withAttributes(['title' => 'Customer']); ?>
                    ...
                    <span class="detail-value"><?php echo e($payment->user->email); ?></span>
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalad5130b5347ab6ecc017d2f5a278b926)): ?>
<?php $attributes = $__attributesOriginalad5130b5347ab6ecc017d2f5a278b926; ?>
                    ...
                    <?php if($payment->bicycle): ?>
                        ...
                        <div class="detail-row">
                            ...
                            <span class="detail-value">
                                ...
                                ?>
                                <span class="badge-admin badge-admin--<?php echo e($bikeStatusBadge); ?>"><?php echo e(ucfirst($payment->bicycle->status)); ?></span>
                            </span>
                        </div>
                        <div class="detail-row">
                    ...
                    <div class="col-6">
                        ...
                        <div class="detail-row">
                            ...
                            <span class="detail-value">
                                ...
                                ?>
                                <span class="badge-admin badge-admin--<?php echo e($rentalStatusBadge); ?>"><?php echo e(ucfirst($payment->rental->status)); ?></span>
                            </span>
                        </div>
                        <div class="detail-row">
