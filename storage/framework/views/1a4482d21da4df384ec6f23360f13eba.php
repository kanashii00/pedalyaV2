...
<div class="admin-table-wrap">
    ...
    <div class="admin-table-toolbar">
        ...
        <form method="GET" action="<?php echo e(route('admin.rentals.index')); ?>" class="d-flex gap-2 align-items-center flex-wrap">
            ...
            <input type="date" name="date_from" class="form-control" value="<?php echo e(request('date_from')); ?>" aria-label="From date">
            <input type="date" name="date_to" class="form-control" value="<?php echo e(request('date_to')); ?>" aria-label="To date">
    ...
    <table class="admin-table">
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $rentals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rental): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td data-label="Rental ID"><code>#<?php echo e($rental->id); ?></code></td>
                    <td data-label="Rider">
                        <div class="d-flex align-items-center">
                            ...
                            <?php echo e($rental->rider->name ?? 'Unknown'); ?>

                        </div>
                    </td>
                    <td data-label="Bicycle"><?php echo e($rental->bicycle->name ?? 'Unknown'); ?></td>
                    <td data-label="Start"><small><?php echo e($rental->startTime?->format('M d, Y h:i A') ?? '—'); ?></small></td>
                    <td data-label="End"><small><?php echo e($rental->endTime?->format('M d, Y h:i A') ?? '—'); ?></small></td>
                    <td data-label="Duration"><?php echo e($rental->durationMinutes ? floor($rental->durationMinutes / 60) . 'h ' . ($rental->durationMinutes % 60) . 'm' : '—'); ?></td>
                    <td data-label="Fee" class="fw-semibold">₱<?php echo e(number_format($rental->totalFee ?? 0, 2)); ?></td>
...
<?php endif; ?>
                        <?php elseif($rental->status === 'overdue'): ?>
                            <?php if (isset($component)) { $__componentOriginal92e51077c3bdcbfa01c516c134fd0f33 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal92e51077c3bdcbfa01c516c134fd0f33 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.badge','data' => ['type' => 'danger','label' => 'Overdue']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin.badge'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'danger','label' => 'Overdue']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal92e51077c3bdcbfa01c516c134fd0f33)): ?>
<?php $attributes = $__attributesOriginal92e51077c3bdcbfa01c516c134fd0f33; ?>
...
<?php endif; ?>
                        <?php else: ?>
                            <?php if (isset($component)) { $__componentOriginal92e51077c3bdcbfa01c516c134fd0f33 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal92e51077c3bdcbfa01c516c134fd0f33 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.badge','data' => ['label' => ucfirst($rental->status)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin.badge'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(ucfirst($rental->status))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal92e51077c3bdcbfa01c516c134fd0f33)): ?>
<?php $attributes = $__attributesOriginal92e51077c3bdcbfa01c516c134fd0f33; ?>
...
<?php endif; ?>
                    ...
                    <td data-label="Payment">
                        <?php if($rental->paymentStatus === 'paid'): ?>
                            <?php if (isset($component)) { $__componentOriginal92e51077c3bdcbfa01c516c134fd0f33 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal92e51077c3bdcbfa01c516c134fd0f33 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.badge','data' => ['type' => 'success','label' => 'Paid']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin.badge'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'success','label' => 'Paid']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal92e51077c3bdcbfa01c516c134fd0f33)): ?>
<?php $attributes = $__attributesOriginal92e51077c3bdcbfa01c516c134fd0f33; ?>
...
<?php endif; ?>
                        <?php else: ?>
                            <?php if (isset($component)) { $__componentOriginal92e51077c3bdcbfa01c516c134fd0f33 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal92e51077c3bdcbfa01c516c134fd0f33 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.badge','data' => ['label' => ucfirst($rental->paymentStatus ?? 'unpaid')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin.badge'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(ucfirst($rental->paymentStatus ?? 'unpaid'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal92e51077c3bdcbfa01c516c134fd0f33)): ?>
<?php $attributes = $__attributesOriginal92e51077c3bdcbfa01c516c134fd0f33; ?>
...
<?php endif; ?>
                    ...
                    <td data-label="Actions">
                        <div class="d-flex gap-1">
                            <button type="button" class="btn-admin btn-admin--secondary btn-admin--sm"
                                    onclick="PedalyaModal.open('rentalDetailModal<?php echo e($rental->id); ?>')" title="View Details">
                                <i class="bi bi-eye"></i>
                            </button>
                ...
                <div class="admin-modal" id="rentalDetailModal<?php echo e($rental->id); ?>">
                    <div class="admin-modal__backdrop"></div>
                    <div class="admin-modal__dialog admin-modal__dialog--lg">
                        <div class="admin-modal__head">
                            <h3><i class="bi bi-key me-2"></i>Rental #<?php echo e($rental->id); ?> Details</h3>
...
<?php endif; ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e($rental->startTime?->format('M d, Y h:i A') ?? '—'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="text-muted">End Time</td>
                                                <td><?php echo e($rental->endTime?->format('M d, Y h:i A') ?? '—'); ?></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e($rental->created_at->format('M d, Y h:i A')); ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                    ...
                                    <table class="table table-sm">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><?php echo e($rental->rider->name ?? 'Unknown'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="text-muted">Email</td>
                                                <td><?php echo e($rental->rider->email ?? '—'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="text-muted">Bicycle</td>
                                                <td><?php echo e($rental->bicycle->name ?? 'Unknown'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="text-muted">Hourly Rate</td>
                                                <td>₱<?php echo e(number_format($rental->bicycle->hourlyRate ?? 0, 2)); ?>/hr</td>
                                            </tr>
                                            <tr>
                                                <td class="text-muted">Total Fee</td>
                                                <td class="fw-bold text-success">₱<?php echo e(number_format($rental->totalFee ?? 0, 2)); ?></td>
                                            </tr>
                                            <tr>
...
<?php endif; ?>
                                                    <?php else: ?>
                                                        <?php if (isset($component)) { $__componentOriginal92e51077c3bdcbfa01c516c134fd0f33 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal92e51077c3bdcbfa01c516c134fd0f33 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.badge','data' => ['type' => 'warning','label' => ucfirst($rental->paymentStatus ?? 'Unpaid')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin.badge'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'warning','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(ucfirst($rental->paymentStatus ?? 'Unpaid'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal92e51077c3bdcbfa01c516c134fd0f33)): ?>
<?php $attributes = $__attributesOriginal92e51077c3bdcbfa01c516c134fd0f33; ?>
...
<?php endif; ?>
                                ...
                                <?php if($rental->notes): ?>
                                    <div class="col-12">
                                        ...
                                        <p class="mb-0"><?php echo e($rental->notes); ?></p>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
...
<?php endif; ?>
    ...
    <div class="admin-table-foot">
        <span>Showing <?php echo e($rentals->total()); ?> records</span>
