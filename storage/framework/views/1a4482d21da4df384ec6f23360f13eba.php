                                ...
                                <div class="rv-actions">
                                    ...
                                    <?php if(in_array($rental->status, ['active', 'overdue'])
                                        ...
                                        <button type="button"
                                                ...
                                                data-pay-action="<?php echo e(route('admin.rentals.mark-paid', $rental->id)); ?>"
                                                data-pay-rental-id="<?php echo e($rental->rentalId); ?>"
                                                data-pay-rider="<?php echo e($rental->rider->name ?? $rental->riderName ?? 'Unknown'); ?>"
                                                data-pay-bike="<?php echo e($rental->bicycle->name ?? $rental->bicycleName ?? 'Unknown'); ?>"
                                                data-pay-fee="<?php echo e(number_format((float) ($rental->totalFee ?? 0), 2)); ?>"
