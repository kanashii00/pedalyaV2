...
<?php endif; ?>
                    ...
                    <td data-label="Actions">
                        <div class="d-flex gap-1">
                            ...
                            <form action="<?php echo e(route('admin.bicycles.lock', $bike->id)); ?>" method="POST" class="d-inline">
                                <?php echo csrf_field(); ?>
                            ...
                            <form action="<?php echo e(route('admin.bicycles.destroy', $bike->id)); ?>" method="POST" class="d-inline">
                                <?php echo csrf_field(); ?>
...
<div class="admin-modal" id="addBicycleModal">
    <div class="admin-modal__backdrop" data-modal-close></div>
    <div class="admin-modal__dialog admin-modal__dialog--lg">
        <form action="<?php echo e(route('admin.bicycles.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="admin-modal__head">
                ...
                <div class="admin-form">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="serialNumber" class="form-control" value="<?php echo e(old('serialNumber')); ?>" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Hourly Rate ($) <span class="text-danger">*</span></label>
                            <input type="number" name="hourlyRate" class="form-control" value="<?php echo e(old('hourlyRate')); ?>" step="0.01" min="0" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Latitude</label>
                            <input type="number" name="currentLat" class="form-control" value="<?php echo e(old('currentLat')); ?>" step="any">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Longitude</label>
                            <input type="number" name="currentLng" class="form-control" value="<?php echo e(old('currentLng')); ?>" step="any">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Battery Level (%)</label>
                            <input type="number" name="batteryLevel" class="form-control" value="<?php echo e(old('batteryLevel', 100)); ?>" min="0" max="100">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">QR Code</label>
                            <input type="text" name="qrCode" class="form-control" value="<?php echo e(old('qrCode')); ?>">
                        </div>
                        <div class="col-12">
                            <label class="form-label">Description</label>
