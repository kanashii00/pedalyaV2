...
@section('title', 'Pedalya - Smart Bicycle Rental')
...
<div class="landing-page">
    ...
    <nav class="navbar navbar-expand-lg landing-nav" id="landingNav">
        <div class="container">
            <a class="navbar-brand" href="{{ route('home') }}">
                <img src="{{ asset('assets/img/Logo.png') }}" alt="Pedalya" style="width:84px;height:84px;border-radius:16px;object-fit:cover;margin-right:16px;">
            ...
            <div class="collapse navbar-collapse" id="landingNavbar">
                <ul class="navbar-nav ms-auto align-items-lg-center gap-lg-2">
                    ...
                    <li class="nav-item ms-lg-3">
                        <a href="{{ route('login') }}" class="btn-pedalya-outline" style="padding: 8px 20px; font-size: 0.88rem;">Sign In</a>
                    </li>
                    <li class="nav-item ms-lg-2">
                        <a href="{{ route('register') }}" class="btn-pedalya" style="padding: 8px 20px; font-size: 0.88rem;">Get Started</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-8 hero-content">
                    ...
                    <div class="d-flex gap-3 flex-wrap mt-4">
                        <a href="{{ route('register') }}" class="btn-pedalya btn-lg px-5">
                ...
                <div class="col-lg-4 hero-logo text-center">
                    <img src="{{ asset('assets/img/Logo.png') }}" alt="Pedalya" style="width:280px;height:280px;border-radius:32px;object-fit:cover;box-shadow:0 20px 60px rgba(0,0,0,0.3);">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row align-items-center g-5">
                <div class="col-lg-6">
                    ...
                    <div class="mt-4">
                        <a href="{{ route('register') }}" class="btn-pedalya btn-lg">
    ...
    <footer class="landing-footer">
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-4">
                    <h6><img src="{{ asset('assets/img/Logo.png') }}" alt="Pedalya" style="width:56px;height:56px;border-radius:10px;object-fit:cover;margin-right:12px;vertical-align:middle;">Pedalya</h6>
            ...
            <div class="footer-bottom">
                &copy; {{ date('Y') }} Pedalya. All rights reserved.
            </div>
        </div>
    </footer>
